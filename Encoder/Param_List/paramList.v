...
parameter WEIGHT_AZ_AP_OUT2 = 12'd560;					//Weight_Az AP uses 16 blocks
parameter MEM_W = 12'd576;								//Top Level's mem_w uses 16 blocks
parameter MEM_W0 = 12'd592;								//Top Level's mem_w0 uses 16 blocks
parameter SYN = 12'd608;								//Top Level's SYN uses 80 blocks
parameter XxXxXxXxXxX = 12'd688;								//Open 8 blocks
...
//parameter T0_FRAC = 12'd2585;								//T0_frac uses 1 block
parameter T_OP = 12'd2586;							//Top Level's T_OP uses 1 block
parameter XXXXXXX = 12'd2587;							//OPEN 1 blocks
...
//parameter NEW_SPEECH = 12'd3456;							//Top Level's OLD_WSP uses 128 Blocks
parameter MEM_ERR = 12'd3456;							//Top Level's MEM_ERR uses 64 Blocks
parameter AI_ZERO = 12'd3520;								//Top Level's ai_zero uses 64 blocks
parameter OLD_WSP = 12'd3584;						   //Top Level's OLD_WSP uses 256 Blocks
parameter SCALED_SIGNAL = 12'd3840;						   //OPEN 256 BLOCKS 
parameter MEM_SYN = 12'd4080;						//Top Level's MEM_SYN uses 16 Blocks
