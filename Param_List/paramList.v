...
parameter XXXXX = 12'd688;					//LSP Select 1 WEGT uses 8 blocks
...
parameter G_PITCH_SCALED_Y1 = 12'd2816;					//G_PITCH_SCALED_Y1 uses 64 Blocks
parameter LSP_QUA_WEGT = 12'd2880;					//Lsp_qua_cs WEGT uses 16 blocks
parameter QUA_LSP_LSF = 12'd2896;					//Qua_lsp lsf uses 16 blocks
parameter QUA_LSP_LSF_Q	= 12'd2912;					//Qua_lsp lsf_q uses 16 blocks
parameter XXXxXx = 12'd2928;								//OPEN 32 Blocks
parameter xx = 12'd2944;								//OPEN 128 Blocks;
