...
parameter CONVOLVE_INPUT_VECTOR = 11'd560;	   		//Convolve input vector uses 64 blocks
parameter CONVOLVE_IMPULSE_RESPONSE = 11'd624;  	//Convolve impulse response uses 64 blocks
parameter CONVOLVE_OUTPUT_VECTOR = 11'd688;			//Convolve output vector uses 64 blocks
parameter XXXXXXX = 11'd752;						//OPEN 16 Blocks
parameter XXXXXXXXXXXXX = 11'd768;					//OPEN 64 Blocks
