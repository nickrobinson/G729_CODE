...
parameter PREV_MA = 12'd2586;             //prev_ma in lspdec.c; uses 1 block;
...
parameter PREV_LSP = 12'd3456;            //prev_lsp[m] uses 10 blocks;
parameter xxXXxxXX = 12'd3472;							//OPEN 112 BLOCKS 
